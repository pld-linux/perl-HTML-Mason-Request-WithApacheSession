...
Summary(pl):	Dodaj sesjê do obiektu Mason::Request
...
%description -l pl
Ten modu³ integruje Apache::Session w Masona poprzez dodanie metod
do obiektu Request, dostêpnego we wszystkich komponentach Masona.
...
%{perl_sitelib}/HTML/Mason/Request/*.pm
%{_mandir}/man3/HTML*
